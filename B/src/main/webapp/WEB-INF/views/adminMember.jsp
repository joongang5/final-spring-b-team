				...
				<div class="sideMenu__block-container">
					<ul class="sideMenu__items">
							...
							<div class="sideMenu-sub-container">
								<ul class="sideMenu__subItems sideMenu__subItems--active">
									<li class="sideMenu__subItem sideMenu__subItem--active"><a
										href="./adminMember.do">회원 목록</a></li>
								</ul>
							</div>
						</li>
						<li class="sideMenu__item">
						...
						<li class="sideMenu__item">
							...
							<div class="sideMenu-sub-container">
								<ul class="sideMenu__subItems">
									<li class="sideMenu__subItem"><a href="./adminLog.do">로그
											조회</a></li>
								</ul>
							</div>
						</li>
				...
				<div class="selects-container">
						...
						<form action="./adminMember.do" method="get">
							...
							<div class="keyword-search__bar">
								<select id="keyword-search__column" name="searchName">
									<option value="m_id"
										<c:if test="${searchName eq 'm_id'}">selected="selected"</c:if>>ID</option>
									<option value="m_name"
										<c:if test="${searchName eq 'm_name'}">selected="selected"</c:if>>이름</option>
									<option value="m_email"
										<c:if test="${searchName eq 'm_email'}">selected="selected"</c:if>>이메일</option>
								</select> <input type="search" name="search" id="keyword-search__word"
					...
					<div class="sort-box">
						<select name="searchName" onchange="order()" id="order">
							...
							<option value="m_no"
								<c:if test="${order eq 'm_no'}">selected="selected"</c:if>>회원번호
								순</option>
							<option value="m_date"
								<c:if test="${order eq 'm_date'}">selected="selected"</c:if>>가입일
								순</option>
						</select>
					</div>
				</div>
									...
									<c:forEach items="${adminMember }" var="am">
										<tr>
											...
											<td><button type="submit"
													onclick="deleteMember('${am.m_id}')">삭제</button></td>
										</tr>
									</c:forEach>
									<!--회원 목록 출력 끝-->
								</tbody>
